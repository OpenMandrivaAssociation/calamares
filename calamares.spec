...
# Welcome/license links start the desktop browser as root; Chromium
# then dies on --no-sandbox. setuid back to live (1000:1002) first.
Patch4:		calamares-3.4.3-open-urls-as-user.patch
